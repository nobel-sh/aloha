...
namespace Aloha
{
  ...
  SrcReader::SrcReader(const std::string &t_filePath) : m_filePath(t_filePath)
  {
  ...
  std::string SrcReader::as_string() const
  {
  ...
  std::vector<char> SrcReader::as_bytes() const
  {
  ...
  bool SrcReader::is_valid_alo_file(const std::string &filePath) const
  {
